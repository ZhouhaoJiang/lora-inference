...
#export MODEL_ID="stablediffusionapi/dreamshaper-v8" # change this
export MODEL_ID="stablediffusionapi/dark-sushi-mix"
...
export REPLICATE_MODEL_ID="dark_sushi_mix_with_lora" # change this
